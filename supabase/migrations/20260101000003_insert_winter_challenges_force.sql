-- Force insert Winter Warrior seasonal challenges (delete old ones first)
-- Migration: 20260101000003_insert_winter_challenges_force

-- Delete any existing winter challenges from 2026
...
-- Insert Winter Warrior challenges (December 2025 - February 2026)
...
-- Verify insertion
SELECT slug, title, season, is_active FROM challenges WHERE season = 'winter' ORDER BY sort_order;
