...
DROP POLICY IF EXISTS "Lakes are viewable by everyone" ON lakes;
...
DROP POLICY IF EXISTS "Admins can insert lakes" ON lakes;
...
DROP POLICY IF EXISTS "Owners can update their claimed lake" ON lakes;
