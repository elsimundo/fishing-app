...
import { Loader2, Fish, Calendar, Trophy, Swords, Pencil, BookOpen, MessageCircle, History } from 'lucide-react'
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-card px-5 py-4">
        ...
        <button
          ...
          className="mt-2 w-full inline-flex items-center justify-center rounded-xl border border-border bg-background px-4 py-2 text-xs font-medium text-muted-foreground hover:border-primary hover:text-primary transition-colors"
        >
