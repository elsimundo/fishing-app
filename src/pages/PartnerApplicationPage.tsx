      ...
      <main className="mx-auto max-w-2xl px-4 py-6 pb-24">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-start gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Become a Sales Partner</h1>
          ...
          <div className="mb-6 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 p-4">
            <h2 className="text-sm font-semibold text-gray-900">Partner Benefits</h2>
          ...
          {/* Example earnings */}
          <div className="mb-6 rounded-xl border border-purple-200 bg-white p-4">
            <h3 className="text-sm font-semibold text-gray-900">Example Earnings</h3>
            <div className="mt-3 space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-600">Sign up 10 businesses at £30/mo avg</span>
                <span className="font-semibold text-purple-700">£75/month</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Sign up 20 businesses at £35/mo avg</span>
                <span className="font-semibold text-purple-700">£175/month</span>
              </div>
              <div className="flex justify-between border-t border-gray-200 pt-2">
                <span className="font-medium text-gray-900">Annual earnings (20 businesses)</span>
