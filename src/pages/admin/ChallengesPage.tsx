      ...
      <div className="p-4 lg:p-8">
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-8 text-center">
            ...
            <p className="mt-4 text-gray-600">No challenges found</p>
          </div>
        ) : (
            ...
            {Object.entries(groupedChallenges || {}).map(([key, group]) => (
              <div key={key} className="rounded-xl border border-gray-200 bg-white overflow-hidden">
                <div className="border-b border-gray-100 bg-gray-50 px-4 py-3">
                  <h2 className="font-semibold text-gray-900">{getScopeLabel(key)}</h2>
                </div>
...
function ChallengeRow({
  ...
  return (
    <div className={`p-4 ${!challenge.is_active ? 'bg-gray-50 opacity-60' : ''}`}>
