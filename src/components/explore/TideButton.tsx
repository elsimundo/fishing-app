          ...
          >
            {isLoading ? (
              <div className="bg-card border border-border rounded-t-2xl md:rounded-2xl p-8 text-center">
                ...
                <p className="font-semibold text-foreground mb-1">Loading Tide Data</p>
                <p className="text-sm text-muted-foreground">Finding nearest tide station...</p>
              </div>
            ) : error || !tideData ? (
              <div className="bg-card border border-border rounded-t-2xl md:rounded-2xl p-8 text-center">
                ...
                <p className="font-semibold text-foreground mb-2">No Tide Data Available</p>
