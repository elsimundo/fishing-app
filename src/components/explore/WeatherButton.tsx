          ...
          >
            {isLoading ? (
              <div className="bg-white rounded-t-2xl md:rounded-2xl p-8 text-center">
                ...
                <p className="font-semibold text-gray-900 mb-1">Loading Weather</p>
                <p className="text-sm text-gray-600">Fetching conditions...</p>
              </div>
            ) : error || !weatherData ? (
              <div className="bg-white rounded-t-2xl md:rounded-2xl p-8 text-center">
                ...
                <p className="font-semibold text-gray-900 mb-2">Weather Unavailable</p>
