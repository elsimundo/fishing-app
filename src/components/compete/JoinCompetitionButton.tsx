...
export function JoinCompetitionButton({ competitionId }: JoinCompetitionButtonProps) {
  ...
  return (
    <button
      ...
      onClick={handleJoin}
      disabled={joining}
      className="flex w-full items-center justify-center gap-2 rounded-xl bg-navy-800 px-4 py-4 text-sm font-semibold text-white transition-colors hover:bg-navy-900 disabled:cursor-not-allowed disabled:opacity-60"
    >
